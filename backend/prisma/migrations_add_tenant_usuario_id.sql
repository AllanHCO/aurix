-- Multi-tenant: adicionar usuario_id em categorias, clientes e produtos.
...
-- ---------- CATEGORIAS ----------
ALTER TABLE categorias ADD COLUMN IF NOT EXISTS usuario_id UUID REFERENCES usuarios(id) ON DELETE CASCADE;
...
-- ---------- CLIENTES ----------
ALTER TABLE clientes ADD COLUMN IF NOT EXISTS usuario_id UUID REFERENCES usuarios(id) ON DELETE CASCADE;
...
-- ---------- PRODUTOS ----------
ALTER TABLE produtos ADD COLUMN IF NOT EXISTS usuario_id UUID REFERENCES usuarios(id) ON DELETE CASCADE;
